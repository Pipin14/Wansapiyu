    ...
    <body>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-4">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="#" class="text-light">Graduation Photography</a></li>
        ...
        <div id="whatsappIcon" class="fixed-bottom rounded-circle">
            <a href="https://wa.me/6281386040075" target="_blank" class="d-flex align-items-center justify-content-center h-100 w-100">

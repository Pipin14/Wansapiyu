...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-3 mb-4"> <!-- Sesuaikan dengan layout yang diinginkan -->
            <div class="card">
                <a href="{{ asset('storage/' . $galeri->galeri_portofolio) }}"
                    data-bs-toggle="modal"
                    data-bs-target="#imageModal{{ $loop->index }}"
                    data-bs-title="{{ $galeri->judul }}">
                    <img src="{{ asset('storage/' . $galeri->galeri_portofolio) }}"
                        class="card-img-top"
                        alt="{{ $galeri->judul }}"
                        loading="lazy">
                </a>
